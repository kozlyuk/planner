...
urlpatterns = [
    ...
    path('invoice/<int:invoice_id>/render/', views.InvoiceRender.as_view(), name='invoice_render'),
    path('invoice/<int:invoice_id>/generate_pdf/', views.InvoiceGeneratePDF.as_view(), name='invoice_generate_pdf'),
